...
const EVIDENCE_FILES = [
  {
    ...
    description: "chat_extraction_01.png",
  },
  {
    id: "evidence_02",
    ...
    description: "chat_extraction_02.png",
  },
  {
    id: "evidence_03",
    ...
    description: "dispatch_call.mp3",
  },
  {
    id: "evidence_04",
    name: "medical_examiner_report.pdf",
    display_name: "medical_examiner\n_report.pdf",
    type: "file",
    ...
    description: "medical_examiner_report.pdf",
  },
  {
    id: "evidence_05",
    name: "scene_item_zolpidem.png",
    display_name: "scene_item\n_zolpidem.png",
    type: "file",
    icon: "/icons/Image.png",
    ...
    description: "scene_item_zolpidem.png",
  },
  {
    id: "evidence_06",
    name: "scene_victim_chris.png",
    display_name: "scene_victim\n_chris.png",
    type: "file",
    icon: "/icons/Image.png",
    ...
    description: "scene_victim_chris.png",
  },
  {
    id: "evidence_07",
    name: "search_history_log.csv",
    display_name: "search_history\n_log.csv",
    type: "file",
    icon: "/icons/Document.png",
    ...
    description: "search_history_log.csv",
  },
  {
    id: "evidence_08",
    ...
    description: "pharmacy_prescription.pdf",
  },
];
      ...
      <div className="window-content">
        <div className="file-list evidence-file-list">
          {EVIDENCE_FILES.map((file) => (
            <FileItem
              key={file.id}
              file={{ ...file, name: file.display_name || file.name }}
